...
//    }
    ...
    public UserDataDto(Integer id, String name, Integer age, String gender, String bio, String location,
                       String interests, String profileImageUrl, Boolean isLikedByMe, Double height,
                       String sports, String games, String relationshipType, Boolean goesGym,
                       Boolean shortHair, Boolean wearGlasses, Boolean drink, Boolean smoke) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.gender = gender;
        ...
        this.interests = interests;
        this.profileImageUrl = profileImageUrl;
        this.isLikedByMe = isLikedByMe != null && isLikedByMe;
        this.height = height;
        this.sports = sports;
        this.games = games;
        this.relationshipType = relationshipType;
